...
import { Mail, Eye, EyeOff, ChevronRight, LogIn, Lock } from "lucide-react";
      ...
      <div className="w-full max-w-[1100px] min-w-[950px] h-[580px] bg-white rounded-[32px] shadow-xl overflow-hidden flex">
        ...
        <div className="w-[55%] p-4">
          <div className="w-full h-full bg-[#9ca3af] relative rounded-[24px]">
            <button className="absolute top-6 right-6 border border-white text-white px-5 py-1.5 rounded-full flex items-center gap-1 text-sm font-medium hover:bg-white/20 transition">
