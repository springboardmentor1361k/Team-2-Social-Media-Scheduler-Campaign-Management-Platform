...
//                   type="submit"
//                   disabled={loading}
//                   className="w-full h-10 bg-[#260b79] hover:bg-[#1f0962] text-white rounded-lg text-[13px] font-semibold shadow-md transition-colors disabled:opacity-60"
//                 >
...
export default function ForgotPasswordForm() {
  ...
  const isValid = isValidEmail(email); // now correctly declared AFTER email exists
